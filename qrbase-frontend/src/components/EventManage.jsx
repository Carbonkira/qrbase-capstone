                 ...
                 <div className="space-y-10">
                     <div className="bg-white p-10 rounded-[3rem] shadow-xl flex flex-col md:flex-row gap-10">
                        <div className="w-full md:w-1/3 h-64 bg-slate-100 rounded-[2rem] overflow-hidden">
                            {event.image ? <img src={getImageUrl(event.image)} className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center text-slate-300 font-black">No Image</div>}
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="w-32 h-32 bg-slate-100 rounded-full mb-8 overflow-hidden border-4 border-white shadow-lg">
                                {selectedSpeaker.photo_path ? (
                                        <img src={getImageUrl(selectedSpeaker.photo_path)} alt={selectedSpeaker.name} className="w-full h-full object-cover" />
                                    ) : (
